...
<div class="container">
	<div class="card">
		<div class="card border-primary mb-3">
			...
			<?= form_open_multipart('dokumen/update', ['class' => 'formUpdate'], ['id' => $dok['id_dokumen'], 'dokumenLama' => $dok['dokumen'], 'created_date' => $dok['created_date'], 'ukuran' => $dok['ukuran'], 'download' => $dok['download']]); ?>
				<div class="card-body">
					<div class="row">
									...
									<div class="input-group mb-3">
										...
										<select name="jenis_id" id="jenis_id" class="form-control select2" style="width: 91%;">
											...
											<?php foreach($jenis as $je) : ?>
												<option <?= ($je['id_jenis'] == $dok['jenis_id'] ? 'selected' : ''); ?> value="<?= $je['id_jenis']; ?>" <?= set_select('jenis_id', $je['id_jenis']); ?>><?= ucwords($je['nama_jenis']); ?></option>
											<?php endforeach; ?>
										</select>
							...
							<div class="form-group row">
								...
								<div class="col-md-8">
									<div class="input-group mb-3">
										...
										<input type="text" name="nama_dokumen" id="nama_dokumen" class="form-control" style="width: 90%; height: 38px" onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1)" value="<?= strtoupper($dok['nama_dokumen']) ?>">
							...
							<div class="form-group row">
								...
								<div class="col-md-8">
									<div class="input-group mb-3">
										...
										<input type="file" name="dokumen" id="dokumen" class="form-control" style="width: 90%; height: 38px" onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1)">
							...
							<div class="form-group row">
								...
								<div class="col-md-8">
									<div class="input-group date" id="tahun" data-target-input="nearest">
										...
										<input type="text" class="form-control tahun datetimepicker-input" data-target="#tahun" name="tahun" style="width: 90%;" value="<?= $dok['tahun']; ?>" />
							...
							<div class="form-group row">
								...
								<div class="col-md-8">
									<div class="input-group mb-3">
										...
										<textarea name="deskripsi" class="form-control" id="deskripsi" style="width: 90%"><?= ucfirst($dok['deskripsi']); ?></textarea>
							...
							<div class="form-group row">
								...
								<div class="col-md-8">
									<div class="input-group date" id="tanggal_upload" data-target-input="nearest">
										...
										<input type="text" class="form-control tanggal_upload datetimepicker-input" data-target="#tanggal_upload" name="tanggal_upload" style="width: 90%;" value="<?= date('d-m-Y', strtotime($dok['tanggal_upload'])); ?>" />
