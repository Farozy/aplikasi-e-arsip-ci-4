...
<div class="container">
	<div class="card">
		...
		<?= form_open('laporan/get_keluar', ['class' => 'formMasuk']) ?>
		<div class="card-body">
			<div class="container">
					...
					<div class="col-md-auto">
						<div class="form-inline mt-3">
							...
							<div class="form-group ml-2" id="excelMasuk">
								<a href="<?= base_url('laporan/export_keluar'); ?>" target="_blank" data-toggle="tooltip" class="btn btn-success" id="exportExcel" title="Export Surat Kelular"><i class="fas fa-file-excel"></i></a>
							</div>
						</div>
					</div>
				</div>
