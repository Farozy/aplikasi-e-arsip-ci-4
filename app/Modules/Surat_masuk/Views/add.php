...
<div class="card">
	<div class="card border-primary mb-3">
		...
		<?= form_open('surat_masuk/save', ['class' => 'formSave']); ?>
			<div class="card-body">
				<div class="row">
						...
						<div class="form-group row" style="margin-top: -1em">
							...
							<div class="col-md-8">
								<div class="input-group mb-3">
									...
									<input type="text" name="pengirim" id="pengirim" class="form-control" style="width: 90%; height: 38px" onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1)" value="<?= old('pengirim'); ?>">
