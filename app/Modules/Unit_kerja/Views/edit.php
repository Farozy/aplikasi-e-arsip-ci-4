<div class="modal fade" id="editModal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<?= form_open('unit_kerja/update', ['class' => 'formUpdate'], ['id' => $unit['id_unit_kerja'], 'created_date' => $unit['created_date']]); ?>
			<?= csrf_field(); ?>
			<div class="modal-body">
				<div class="form-group row">
					<label for="nama_unit_kerja" class="col-form-label col-md-4 text-right">Nama Unit Kerja</label>
					<div class="col-md-7">
						<input class="form-control" id="nama_unit_kerja" name="nama_unit_kerja" value="<?= ucwords($unit['nama_unit_kerja']); ?>" style="height: 38px" onkeyup="this.value = this.value.replace (/\w\S*/g, function(txt) { return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase(); });">
