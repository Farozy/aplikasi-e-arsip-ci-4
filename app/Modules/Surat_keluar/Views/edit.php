...
<div class="card">
	<div class="card border-primary mb-3">
		...
		<?= form_open('surat_keluar/update', ['class' => 'formUpdate'], ['id' => $keluar['id_surat_keluar'], 'created_date' => $keluar['created_date'], 'disposisi' => $keluar['disposisi'], 'tanggal_disposisi' => $keluar['tanggal_disposisi'], 'ket_disposisi' => $keluar['ket_disposisi']]); ?>
			<div class="card-body">
				<div class="row">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<div class="input-group mb-3">
									...
									<input type="text" name="no_surat" id="no_surat" class="form-control" style="width: 89%; height: 38px" onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1)" value="<?= $keluar['no_surat'] ?>">
						...
						<div class="form-group row" style="margin-top: -1em">
							...
							<div class="col-md-8">
								<div class="input-group date" id="tanggal" data-target-input="nearest">
									...
									<input type="text" class="form-control tanggal datetimepicker-input" data-target="#tanggal" name="tanggal" style="width: 90%;" value="<?= date('d-m-Y', strtotime($keluar['tanggal'])); ?>" />
							...
							<div class="col-md-8">
								<div class="input-group mb-3">
									...
									<select name="sifat_surat" id="sifat_surat" class="form-control select2" style="width: 91%;">
										...
										<option <?= ($keluar['sifat_surat'] == 'segera' ? 'selected' : ''); ?> value="segera">Segera</option>
										<option <?= ($keluar['sifat_surat'] == 'penting' ? 'selected' : ''); ?> value="penting">Penting</option>
										<option <?= ($keluar['sifat_surat'] == 'rahasia' ? 'selected' : ''); ?> value="rahasia">Rahasia</option>
										<option <?= ($keluar['sifat_surat'] == 'biasa' ? 'selected' : ''); ?> value="biasa">Biasa</option>
									</select>
						...
						<div class="form-group row" style="margin-top: -1em">
							...
							<div class="col-md-8">
								<div class="input-group mb-3">
									...
									<input type="text" name="pengirim" id="pengirim" class="form-control" style="width: 90%; height: 38px" onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1)" value="<?= ucwords($keluar['pengirim']) ?>">
						...
						<div class="form-group row" style="margin-top: -1em">
							...
							<div class="col-md-8">
								<div class="input-group mb-3">
									...
									<input type="text" name="perihal" id="perihal" class="form-control" style="width: 90%; height: 38px" onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1)" value="<?= ucfirst($keluar['perihal']) ?>">
						...
						<div class="form-group row" style="margin-top: -1em">
							...
							<div class="col-md-8">
								<div class="input-group mb-3">
									...
									<input type="text" name="tertuju" id="tertuju" class="form-control" style="width: 90%; height: 38px" onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1)" value="<?= ucwords($keluar['tertuju']); ?>">
						...
						<div class="form-group row" style="margin-top: -1em">
							...
							<div class="col-md-8">
								<div class="input-group mb-3">
									...
									<textarea name="alamat" class="form-control" id="alamat" style="width: 90%"><?= ucfirst($keluar['alamat']); ?></textarea>
						...
						<div class="form-group row" style="margin-top: -1em">
							...
							<div class="col-md-8">
								<div class="input-group mb-3">
									...
									<textarea name="isi_surat" class="form-control" id="isi_surat" style="width: 90%"><?= ucfirst($keluar['isi_surat']); ?></textarea>
